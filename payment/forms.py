...
class ShippingForm(forms.ModelForm):
    ...
    shipping_email     = forms.CharField(label='', widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': "E-mail Address"}), required=True)
...
class PaymentForm(forms.Form):
    ...
    card_address2 = forms.CharField(label='', widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': "Complement"}), required=False)
